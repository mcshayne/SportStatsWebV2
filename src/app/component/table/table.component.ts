...
leagueId:number = 0;
  ...
  tableTitles: string[] = ['#','Team','Played','Won','Drawn','Lost','For','Against','GD','P'];
  tableTitlesHover: string[] = ['Place','Team','Played','Won games','Drawn games','Lost games','Goals for','Goals against','Goal difference','Points'];
  ...
  constructor(private getSeasons: getSeasonsForLeagueAndSport
